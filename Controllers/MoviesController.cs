...
namespace COMP003B.SP26.FinalProject.ZachJ.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public MoviesController(FinalsContext context)
        {
            _context = context;
        }
        ...
        {
            var finalsContext = _context.Movies.Include(m => m.User);
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Genre,Rating,Comments,UserId")] Movies movies)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Genre,Rating,Comments,UserId")] Movies movies)
        {
            if (id != movies.Id)
            {
                return NotFound();
