...
namespace COMP003B.SP26.FinalProject.ZachJ.Controllers
{
    public class GamesController : Controller
    {
        ...
        {
            var finalsContext = _context.Games.Include(g => g.User);
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Genre,Rating,Comments,UserId")] Games games)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Genre,Rating,Comments,UserId")] Games games)
        {
            if (id != games.Id)
            {
                return NotFound();
